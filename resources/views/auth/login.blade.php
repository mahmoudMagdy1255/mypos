...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ url('dashboard')}}/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ url('dashboard')}}/css/AdminLTE.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ url('dashboard')}}/css/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Dashboard | Login</b></a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{ url('dashboard')}}/js/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
